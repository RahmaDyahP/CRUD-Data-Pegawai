  ...
  <div class="container h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-xl-9">
        ...
        <h1 align="center" class="text-white mb-4">Registrasi Pegawai</h1>
          ...
          <div class="card-body">
            <form action="proses_registrasi_pegawai.php" method="post">
              ...
              <div class="row align-items-center py-3">
                ...
                <div class="col-md-9 pe-5">
                  <textarea name="Alamat" class="form-control form-control-lg" rows="3" placeholder="Masukkan Alamat" required></textarea>
                </div>
              </div>
              ...
              <div class="row align-items-center py-3">
                ...
                <div class="col-md-9 pe-5">
                  <input type="text" name="No_telp" class="form-control form-control-lg" placeholder="Masukkan Nomor Telepon" required />
                </div>
              </div>
              ...
              <div class="row align-items-center py-3">
                ...
                <div class="col-md-9 pe-5">
                  <select name="Jabatan" class="form-control form-control-lg" required>
              ...
              <div class="px-5 py-4">
                <button type="submit" class="btn btn-primary btn-lg">Tambah Pegawai</button>
              </div>
